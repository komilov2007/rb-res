...
const LoginRequired = ({ message }: LoginRequiredProps) => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 rounded-2xl border border-gray180 bg-white px-6 py-10 text-center">
      <p className="text-sm font-medium text-gray220">{message}</p>
      <Button
        type="button"
        variant="plain"
        size="none"
