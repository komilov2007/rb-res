          ...
          <div className="flex flex-col">
            ...
            <div className="branch-yandex-map relative h-[505px] w-full overflow-hidden bg-gray10">
              ...
              <button
                ...
                className="absolute bottom-4 left-1/2 z-20 flex h-10 w-[190px] -translate-x-1/2 items-center justify-center gap-1.5 rounded-full bg-primary px-3 text-xs font-medium text-white shadow-[0_10px_24px_rgba(0,0,0,0.2)] ring-1 ring-white/60"
              >
