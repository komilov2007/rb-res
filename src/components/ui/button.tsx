...
const buttonVariants = cva(
  "inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap font-medium outline-none transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "rounded-lg bg-primary text-sm font-medium text-white hover:bg-primary/90",
        destructive: "rounded-lg bg-red/10 text-sm font-medium text-red",
        secondary: "rounded-xl bg-gray10 text-sm font-medium text-black",
        ...
        soft: "rounded-xl bg-gray10 text-sm font-medium text-black hover:bg-gray180",
        outline:
          "rounded-xl border border-gray180 bg-white text-sm font-medium text-black hover:bg-gray10",
        ...
        "product-add":
          "rounded-2xl border border-primary/10 bg-white text-sm font-medium text-primary  active:scale-[0.98]",
        counter:
          "overflow-hidden rounded-2xl border border-primary/10 bg-white p-1 text-primary",
        "counter-action":
          "shrink-0 overflow-hidden rounded-none p-0 text-lg font-medium text-primary active:scale-90",
        "counter-value":
        ...
        "primary-solid":
          "rounded-xl bg-primary text-sm font-medium text-white hover:bg-primary/90",
        "floating-cart":
